...
if (numVisits !==0) {
	visitsDisplay.textContent = `Esta es su visita  #: ${numVisits}`;
} else {
	visitsDisplay.textContent = "Bienvenido(a) esta es su primer visita!";
}
...
function eliminaAnuncio(){
	const elemento = document.getElementById("anuncio");
	elemento.remove();
